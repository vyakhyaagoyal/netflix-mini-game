 ...
 */
export const APP_NAME: string = 'netflix-mini-game';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'A Farcaster mini app to test Netflix personality of a person';
 ...
 */
export const APP_TAGS: string[] = ['game', 'netflix', 'personality', 'test', 'quiz', 'fun', 'similar'];
